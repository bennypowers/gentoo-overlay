...
src_configure() {
	local mycmakeargs=(
		...
		# Do NOT set LLVM_LIBDIR_SUFFIX — it breaks the fat archive build
		# by making bundled LLVM use lib64/ while the MRI script expects lib/.
		# The bundled LLVM is internal only; CMAKE_INSTALL_LIBDIR controls
