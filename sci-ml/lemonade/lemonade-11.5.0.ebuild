...
inherit cmake desktop rust systemd
...
src_configure() {
	local mycmakeargs=(
		...
		-DHTTPLIB_INCLUDE_DIRS=/usr/include
		-DHTTPLIB_LIBRARIES=cpp-httplib
		-DHTTPLIB_LIBRARY_DIRS=/usr/lib64
...
src_install() {
	...
	if use gui; then
		...
		domenu data/lemonade-app.desktop
	fi
