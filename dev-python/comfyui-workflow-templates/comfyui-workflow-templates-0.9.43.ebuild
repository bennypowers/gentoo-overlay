...
RDEPEND="
	~dev-python/comfyui-workflow-templates-core-0.3.192[${PYTHON_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-api-0.3.68[${PYTHON_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-video-0.3.71[${PYTHON_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-image-0.3.117[${PYTHON_USEDEP}]
	~dev-python/comfyui-workflow-templates-media-other-0.3.164[${PYTHON_USEDEP}]
"
