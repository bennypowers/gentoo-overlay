...
src_install() {
	...
	# Install LPD filter files as executables
	exeinto /usr/lib/cups/filter
	doexe "${S}/opt/brother/Printers/${PRINTER_MODEL}/lpd/${ABI}/brmfcl3760cdwfilter"
	doexe "${S}/opt/brother/Printers/${PRINTER_MODEL}/lpd/${ABI}/brprintconf_mfcl3760cdw"
