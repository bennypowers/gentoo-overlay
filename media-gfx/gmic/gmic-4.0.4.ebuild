...
# gmic-qt HEAD snapshot for GIMP 3.0 API compatibility
GMIC_QT_COMMIT="aee7e94d7306825c5537222c920531086a107eb3"
GMIC_QT_URI="https://github.com/GreycLab/gmic-qt/archive/${GMIC_QT_COMMIT}.tar.gz -> gmic-qt-${GMIC_QT_COMMIT::8}.tar.gz"
