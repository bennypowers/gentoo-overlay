...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		~dev-python/comfy-kitchen-0.2.26[${PYTHON_USEDEP}]
		...
		~dev-python/comfyui-frontend-package-1.47.12[${PYTHON_USEDEP}]
		~dev-python/comfyui-workflow-templates-0.11.28[${PYTHON_USEDEP}]
		~dev-python/comfyui-embedded-docs-0.5.9[${PYTHON_USEDEP}]
	')
	media-libs/mesa[egl(+)]
	...
	cuda? ( $(python_gen_cond_dep '~dev-python/comfy-aimdo-0.4.11[${PYTHON_USEDEP}]') )
	migraphx? (
