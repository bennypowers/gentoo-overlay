...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		~dev-python/comfyui-frontend-package-1.43.18[${PYTHON_USEDEP}]
		~dev-python/comfyui-workflow-templates-0.9.73[${PYTHON_USEDEP}]
		~dev-python/comfyui-embedded-docs-0.4.4[${PYTHON_USEDEP}]
	')
	...
	cuda? ( $(python_gen_cond_dep '~dev-python/comfy-aimdo-0.3.0[${PYTHON_USEDEP}]') )
	migraphx? (
