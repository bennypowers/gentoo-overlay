...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		>=dev-python/comfy-kitchen-0.2.10[${PYTHON_USEDEP}]
		...
		~dev-python/comfyui-frontend-package-1.45.19[${PYTHON_USEDEP}]
		~dev-python/comfyui-workflow-templates-0.10.7[${PYTHON_USEDEP}]
		~dev-python/comfyui-embedded-docs-0.5.5[${PYTHON_USEDEP}]
	')
