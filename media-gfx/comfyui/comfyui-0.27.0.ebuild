...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		~dev-python/comfy-kitchen-0.2.16[${PYTHON_USEDEP}]
		...
		~dev-python/comfyui-frontend-package-1.45.20[${PYTHON_USEDEP}]
		~dev-python/comfyui-workflow-templates-0.11.1[${PYTHON_USEDEP}]
		~dev-python/comfyui-embedded-docs-0.5.6[${PYTHON_USEDEP}]
	')
	media-libs/mesa[egl(+)]
