...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		~dev-python/comfyui-frontend-package-1.45.15[${PYTHON_USEDEP}]
		~dev-python/comfyui-workflow-templates-0.9.98[${PYTHON_USEDEP}]
		~dev-python/comfyui-embedded-docs-0.5.3[${PYTHON_USEDEP}]
	')
	...
	cuda? ( $(python_gen_cond_dep '~dev-python/comfy-aimdo-0.4.9[${PYTHON_USEDEP}]') )
	migraphx? (
