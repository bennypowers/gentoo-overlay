...
SRC_URI="
	https://github.com/hyprlab/hylki/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_install() {
	...
	domenu data/co.hyprlab.Hylki.desktop

	insinto /usr/share/metainfo
	doins data/co.hyprlab.Hylki.metainfo.xml
}
