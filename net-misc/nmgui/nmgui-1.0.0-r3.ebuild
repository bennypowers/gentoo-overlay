...
src_prepare() {
	...
	# Fix imports in main.py to use absolute imports
	sed -i 's/from network_service import NetworkService/from app.network_service import NetworkService/' app/main.py
	sed -i 's/from ui.main_window import MainWindow/from app.ui.main_window import MainWindow/' app/main.py
	sed -i 's/from ui.styles import load_css/from app.ui.styles import load_css/' app/main.py
	
	# Fix any other relative imports in the app directory
