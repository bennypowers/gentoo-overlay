...
CRATES="
	...
	swc_ecma_transforms_base@44.0.1
	swc_ecma_utils@31.0.0
...
src_prepare() {
	...
	# Redirect whamm git dep to vendored source for any transitive resolution
	cat >> Cargo.toml <<-EOF
